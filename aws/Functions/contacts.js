  ...
  if (event.schema === 'contacts') {
    ...
    switch (event.method) {
      ...
      default:
        return async () => {
          let response = await data;
          return context.succeed("Lambda Contacts Schema API ... Please Supply Correct Query Mapping!");
        }
    }
  } else {
    return context.succeed("Lambda Contacts Schema API ... Please Supply Correct Schema!")
  }
}